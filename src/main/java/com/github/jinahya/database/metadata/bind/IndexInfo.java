...
public class IndexInfo
     ...
     * {@link java.sql.DatabaseMetaData#getIndexInfo(String, String, String, boolean, boolean)}, placing {@code null}
     * values (of all keys) as the specified context's database sorts them.
     *
