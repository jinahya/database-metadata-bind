...
public class Column
     ...
     * {@link java.sql.DatabaseMetaData#getColumns(String, String, String, String)}, placing {@code null} values (of all
     ...
     */
    static Comparator<Column> comparingInJdbcOrder(final Context context,
