...
@XmlRootElement(name = "tablePrivilege")
@XmlType(name = "tablePrivilege")
public class TablePrivilege
     ...
     * {@link java.sql.DatabaseMetaData#getTablePrivileges(String, String, String)}, placing {@code null} values as the
     ...
     */
    static Comparator<TablePrivilege> comparingInJdbcOrder(final Context context,
