...
record _SupportsConvert(int fromType, int toType, boolean result) {

    static <E extends Enum<E> & SQLType> _SupportsConvert of(final E fromType, final E toType,
                                                             final boolean result) {
        Objects.requireNonNull(fromType, "fromType is null");
        Objects.requireNonNull(toType, "toType is null");
        return new _SupportsConvert(
